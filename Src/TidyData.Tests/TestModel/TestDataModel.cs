 ...
 namespace TidyData.Tests.TestModel
{
    ...
    public class TestDataModel : IDataModel
    {
        ...
        public Dictionary<Guid, TestDocumentWithForeignKey> DocsWithForeignKey { get; } = new Dictionary<Guid, TestDocumentWithForeignKey>();
        ...
        public IEnumerable<ICollectionWrapper> GetCollections(IClock clock = null)
        {
            ...
            yield return new CollectionWrapper<TestDocumentWithForeignKey>(this, nameof(this.DocsWithForeignKey), this.DocsWithForeignKey, clock);
        }

        public IEnumerable<IForeignKeyDefinition> GetForeignKeyDefinitions()
        {
            yield return new ForeignKeyDefinition<TestDocumentWithForeignKey>(nameof(this.Docs), this.DocsWithForeignKey, x => x.TestDocumentId);
        }
    }
